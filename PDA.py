...
class PDAVisualizer:
    ...
    def draw_pda_diagram(self):
        ...
        self.canvas.create_text(225, 130, text="b, a -> ϵ", font=("Arial", 10))

        self.canvas.create_line(350, 150, 400, 150, arrow=tk.LAST)
        self.canvas.create_text(375, 130, text="ϵ, Z -> Z", font=("Arial", 10))

        # Self-loop on q0 for a transitions
        ...
        self.canvas.create_text(150, 20, text="a, a -> aa", font=("Arial", 10))
    
         # Self-loop on q1 for a transitions
        ...
        self.canvas.create_line(175, 95, 160, 110, arrow=tk.LAST)
        self.canvas.create_text(300, 40, text="a, a -> ϵ", font=("Arial", 10))
